...
export type DetectedLanguage = 'TypeScript' | 'JavaScript' | 'Python' | 'Rust' | 'Go' | 'Java' | 'Kotlin' | 'Ruby' | 'PHP' | 'C#' | 'C++' | 'C' | 'Shell' | 'Dockerfile' | 'Unknown';
/** Detected framework in scanned repo */
export type DetectedFramework = 'Next.js' | 'React' | 'Vue' | 'Angular' | 'Svelte' | 'FastAPI' | 'Django' | 'Flask' | 'Express' | 'NestJS' | 'Spring Boot' | 'Rails' | 'Laravel' | 'ASP.NET' | 'Tauri' | 'Electron' | 'None' | 'Unknown';
